...
export const KPI_VALUES = {
  ...
  // DEO scope = one district. Values mirror the District column of the
  // Gujarat VSK KPI Framework PDF (page-1 + page-2 rollups).
  deo: {
    attendance_today:               { value: 88,  meta: {} },
    chronic_absentees:              { value: 4200, meta: { priorityCount: 980 } },
    schools_below_attendance_benchmark: { value: 140, meta: {} },
    attendance_reporting_compliance:{ value: 97,  meta: {} },
    assessment_participation:       { value: 93,  meta: { absentCount: 3400 } },
    proficiency:                    { value: 61,  meta: {} },
    students_below_proficiency:     { value: 29,  meta: { studentCount: 18200, priorityCount: 4200 } },
    student_improvement_delta:      { value: 2.0, meta: {} },
    orf_fln_improvement:            { value: 4,   meta: {} },
    reports_generated_downloaded:   { value: 93,  meta: { pendingSchools: 88 } },
    student_module_completion:      { value: 65,  meta: { pendingStudents: 7800 } },
    tpd_hours:                      { value: 41,  meta: {} },
    scheme_beneficiary_mapping:     { value: 84,  meta: { unmapped: 1840 } },
    payment_completion:             { value: 76,  meta: { pendingPayments: 1240 } },
    pending_payments_grievances:    { value: 2200, meta: {} },
    issue_resolution_sla:           { value: 71,  meta: { openOverdue: 188 } },
    repeat_pending_cases:           { value: 470, meta: {} },
    gsqac_score:                    { value: 71,  meta: {} },
    schools_meeting_quality_benchmark: { value: 65, meta: {} },
    low_performing_schools:         { value: 118, meta: {} },
    gsqac_improvement_cycles:       { value: 8,   meta: {} },
    improvement_actions_completed:  { value: 81,  meta: { openActions: 412 } },
    pending_issues_cross_system:    { value: 1520, meta: {} },
    repeat_issues_pct:              { value: 9,   meta: {} },
    action_on_ews_flagged:          { value: 71,  meta: { pendingCount: 612 } },
    dropout_reduction:              { value: 2.9, meta: {} },
    reenrollment_vs_target:         { value: 1840, meta: { target: 2400 } },
    samagra_shiksha_expenditure:    { value: 80,  meta: {} },
    pm_shri_performance:            { value: 78,  meta: {} },
  },
  state_secretary: {
    attendance_today:               { value: 88,  meta: {} },
